...
train_test_split <- initial_split(customer_data, prop = 0.8, strata = reordered)
...
# Fit the model using tidymodels workflow
model_fit <- fit(model_spec, reordered ~ product_id + add_to_cart_order, data = train_data)
...
predictions <- predict(model_fit, new_data = test_data, type = "prob")

# Calculate ROC curve and AUC
roc_curve <- roc(test_data$reordered, predictions$`1`)
plot(roc_curve)
```
